...
type Request_EliminatedTx struct {
	EliminatedTx *RequestEliminatedTx `protobuf:"bytes,18,opt,name=eliminated_tx,json=eliminatedTx,proto3,oneof" json:"eliminated_tx,omitempty"`
}
...
func (*Request_EliminatedTx) isRequest_Value()       {}
...
func (m *Request) GetEliminatedTx() *RequestEliminatedTx {
	if x, ok := m.GetValue().(*Request_EliminatedTx); ok {
		return x.EliminatedTx
	}
	return nil
}
...
type RequestEliminatedTx struct {
	Txs [][]byte `protobuf:"bytes,1,rep,name=txs,proto3" json:"txs,omitempty"`
}

func (m *RequestEliminatedTx) Reset()         { *m = RequestEliminatedTx{} }
func (m *RequestEliminatedTx) String() string { return proto.CompactTextString(m) }
func (*RequestEliminatedTx) ProtoMessage()    {}
func (*RequestEliminatedTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{8}
}
func (m *RequestEliminatedTx) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestEliminatedTx) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestEliminatedTx.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestEliminatedTx) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestEliminatedTx.Merge(m, src)
}
func (m *RequestEliminatedTx) XXX_Size() int {
	return m.Size()
}
func (m *RequestEliminatedTx) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestEliminatedTx.DiscardUnknown(m)
}

var xxx_messageInfo_RequestEliminatedTx proto.InternalMessageInfo

func (m *RequestEliminatedTx) GetTxs() [][]byte {
	if m != nil {
		return m.Txs
	}
	return nil
...
type Response_EliminatedTx struct {
	EliminatedTx *ResponseEliminatedTx `protobuf:"bytes,19,opt,name=eliminated_tx,json=eliminatedTx,proto3,oneof" json:"eliminated_tx,omitempty"`
}
...
func (*Response_EliminatedTx) isResponse_Value()       {}
...
func (m *Response) GetEliminatedTx() *ResponseEliminatedTx {
	if x, ok := m.GetValue().(*Response_EliminatedTx); ok {
		return x.EliminatedTx
	}
	return nil
}
...
type ResponseCheckTx struct {
	...
	// replaceable tx
	ReplaceableTx []byte `protobuf:"bytes,25,opt,name=replaceable_tx,json=replaceableTx,proto3" json:"replaceable_tx,omitempty"`
}
...
func (m *ResponseCheckTx) GetSignerAddress() string {
	if m != nil {
...
func (m *ResponseCheckTx) GetNonce() uint64 {
	if m != nil {
		return m.Nonce
	}
	return 0
...
func (m *ResponseCheckTx) GetGasLimit() uint64 {
	if m != nil {
		return m.GasLimit
	}
	return 0
...
func (m *ResponseCheckTx) GetGasPrice() uint64 {
	if m != nil {
		return m.GasPrice
	}
	return 0
...
func (m *ResponseCheckTx) GetType() int32 {
	if m != nil {
		return m.Type
	}
	return 0
...
func (m *ResponseCheckTx) GetReplaceableTx() []byte {
	if m != nil {
		return m.ReplaceableTx
	}
	return nil
}
...
type ResponseEliminatedTx struct {
}

func (m *ResponseEliminatedTx) Reset()         { *m = ResponseEliminatedTx{} }
func (m *ResponseEliminatedTx) String() string { return proto.CompactTextString(m) }
func (*ResponseEliminatedTx) ProtoMessage()    {}
func (*ResponseEliminatedTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{36}
}
func (m *ResponseEliminatedTx) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseEliminatedTx) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseEliminatedTx.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseEliminatedTx) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseEliminatedTx.Merge(m, src)
}
func (m *ResponseEliminatedTx) XXX_Size() int {
	return m.Size()
}
func (m *ResponseEliminatedTx) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseEliminatedTx.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseEliminatedTx proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*RequestEliminatedTx)(nil), "tendermint.abci.RequestEliminatedTx")
	...
	proto.RegisterType((*ResponseEliminatedTx)(nil), "tendermint.abci.ResponseEliminatedTx")
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
...
type ABCIApplicationClient interface {
	...
	EliminatedTx(ctx context.Context, in *RequestEliminatedTx, opts ...grpc.CallOption) (*ResponseEliminatedTx, error)
}
...
func (c *aBCIApplicationClient) EliminatedTx(ctx context.Context, in *RequestEliminatedTx, opts ...grpc.CallOption) (*ResponseEliminatedTx, error) {
	out := new(ResponseEliminatedTx)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCIApplication/EliminatedTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ABCIApplicationServer interface {
	...
	EliminatedTx(context.Context, *RequestEliminatedTx) (*ResponseEliminatedTx, error)
}
...
func (*UnimplementedABCIApplicationServer) EliminatedTx(ctx context.Context, req *RequestEliminatedTx) (*ResponseEliminatedTx, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EliminatedTx not implemented")
}
...
func _ABCIApplication_EliminatedTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestEliminatedTx)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIApplicationServer).EliminatedTx(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCIApplication/EliminatedTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIApplicationServer).EliminatedTx(ctx, req.(*RequestEliminatedTx))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ABCIApplication_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "EliminatedTx",
			Handler:    _ABCIApplication_EliminatedTx_Handler,
		},
	},
...
func (m *Request_EliminatedTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_EliminatedTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.EliminatedTx != nil {
		{
			size, err := m.EliminatedTx.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RequestEliminatedTx) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestEliminatedTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestEliminatedTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Response_EliminatedTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_EliminatedTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.EliminatedTx != nil {
		{
			size, err := m.EliminatedTx.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ResponseCheckTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ReplaceableTx) > 0 {
		i -= len(m.ReplaceableTx)
		copy(dAtA[i:], m.ReplaceableTx)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.ReplaceableTx)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xca
...
func (m *ResponseEliminatedTx) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseEliminatedTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseEliminatedTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Request_EliminatedTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestEliminatedTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_EliminatedTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseCheckTx) Size() (n int) {
	...
	if m.GasLimit != 0 {
		n += 2 + sovTypes(uint64(m.GasLimit))
	}
	if m.GasPrice != 0 {
		n += 2 + sovTypes(uint64(m.GasPrice))
	}
	if m.Type != 0 {
		n += 2 + sovTypes(uint64(m.Type))
	}
	l = len(m.ReplaceableTx)
	if l > 0 {
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
...
func (m *ResponseEliminatedTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EliminatedTx", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &RequestEliminatedTx{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Request_EliminatedTx{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *RequestEliminatedTx) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestEliminatedTx: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestEliminatedTx: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			...
			v := &ResponseEliminatedTx{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Response_EliminatedTx{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *ResponseCheckTx) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 25:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReplaceableTx", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ReplaceableTx = append(m.ReplaceableTx[:0], dAtA[iNdEx:postIndex]...)
			if m.ReplaceableTx == nil {
				m.ReplaceableTx = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *ResponseEliminatedTx) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseEliminatedTx: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseEliminatedTx: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
